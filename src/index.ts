...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    if(!gl) {
        console.error('WebGL is not supported on your browser/device.');
        return;
    }
    ...
    // Example from: https://developer.mozilla.org/en-US/docs/Web/API/WebGL_API/Tutorial/Adding_2D_content_to_a_WebGL_context
});